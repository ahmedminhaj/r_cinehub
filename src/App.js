            ...
            <div className="rating">
              {!isWatched ? 
                <> 
                  ...
                  />
                  {userRating > 0 && (<button className="btn-add" onClick={handleAdd}>+ Add to watched</button>)}
                </> : <p>Already rated this movie {watchedUserRating}<span>⭐</span></p>
              }
            </div>
            <p>
              <em>{plot}</em>
